...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    definition:
      'Атака и защита обороняющихся боевых единиц повышаются на определенный процент. К тому же гильдия получает определенную прибавку к резерву.',
  },
  {
    id: 'scroll',
    name: 'Квест-бонус',
  ...
  },
  {
    ...
    definition:
      'В первых битвах есть шанс убить одну боевую единицу врага в начале боя. Если в битве две волны, то умение действует только во время первой.',
  },
  {
    id: 'double_collect',
  ...
  },
  {
    ...
    definition:
      'В первых битвах есть шанс убить половину войска врага в начале боя. Если в битве две волны, то умение применяется только к первой волне.',
  },
  {
    id: 'diplomatic_gifts',
  ...
  },
  {
    ...
    definition:
      'Начиная с эпохи Арктического будущего производит особые ресурсы каждые 24 часа. Вероятность и типы особых ресурсов зависят от эпохи. До эпохи Арктического будущего производит медали.',
  },
];
