...
export const GREAT_BUILDING: GreatBuilding[] = [
  {
    ...
    definition:
      'Построенная для наблюдения астрономических событий, высокая Обсерватория собирает знания, которые неоценимы для альянсов. Помимо наблюдения за звездами и небом, слежение за земными событиями помогает обнаружить новые ресурсы и получить преимущество над конкурентами.',
  ...
  },
  {
    ...
    place: { x: 3, y: 3, b: 1 },
    definition:
      'Жрица Дельфийского оракула слышала слова бога Аполлона и говорила от его имени. Древние греки и чужеземцы задавали ей вопросы, чтобы заглянуть в своё будущее.',
  ...
  },
  {
    ...
    place: { x: 4, y: 4, b: 1 },
    definition:
      'Легендарная Вавилонская башня должна была быть произведением искусства древних архитекторов. Если бы она существовала, она бы утонула в посетителях со всех уголков планеты.',
  ...
  },
  {
    ...
    era: 3,
    definition:
      'Колизей — бриллиант, венчающий корону города городов, коим являлся Рим. В нём устраивалось множество развлечений, но нам он запомнился как место проведения кровавых боёв гладиаторов.',
  ...
  },
  {
    ...
    era: 3,
    definition:
      'Веками Александрийский Маяк был самым высоким рукотворным строением на Земле. Его луч света направлял путников со всего света в порт Александрии.',
  ...
  },
  {
    ...
    era: 4,
    definition:
      'Одна из самых старых и самых великих церквей в мире, Собор святой Софии, была посвящена мудрости Бога. Она была гордостью всех империй, которые удерживали её.',
  ...
  },
  {
    ...
    era: 5,
    definition:
      'Построенная торговцами Венецианской республики, Базилика показывала богатство и силу Венецианских торговцев. Веками добавлялось всё больше и больше украшений, большинство из которых, были привезены из далёких стран.',
  ...
  },
  {
    ...
    era: 5,
    definition:
      'Собор Парижской Богоматери был вершиной архитектурного искусства и не имел аналогов в западной Европе. Его великолепие и безупречность вдохновляли всех ремесленников, которые смотрели на него.',
  ...
  },
  {
    ...
    era: 6,
    definition:
      'Храм Василия Блаженного на Красной площади Москвы был построен в честь завершения Русско-Казанской войны. Он вдохновляет всех россиян и является центральной точкой Москвы.',
  ...
  },
  {
    ...
    era: 6,
    definition:
      'Таинственный Кастель-дель-Монте скорее всего предназначался для того, чтобы удерживать дворян-повстанцев. Множество его загадок и особенностей озадачивают учёных до сих пор.',
  ...
  },
  {
    ...
    era: 7,
    definition:
      'Построенный Генрихом VIII, чтобы противостоять объединённому франко-испанскому нашествию, Дильский замок прошёл проверку временем, доказав, что он является ценным стратегическим достоянием Британской империи.',
  ...
  },
  {
    ...
    era: 7,
    definition:
      'Построенный совместными усилиями протестантского населения Дрездена и их Римско-Католическим правителем, Фрауэнкирхе устояла перед многим трудностями и войнами.',
  ...
  },
  {
    ...
    era: 8,
    definition:
      'Здание Капитолия в Вашингтоне, округ Колумбия, где собирались представители всех штатов входящих в состав страны. Он является символом победы демократии в Новом Свете, манящий к себе людей со всех уголков земного шара.',
  ...
  },
  {
    ...
    era: 8,
    definition:
      'Назван в память об Альберте, Принце-консорте Соединенного королевства при королеве Виктории, Королевский Альберт-холл место проведения самых значимых событий Великобритании. Его атмосфера и репутация притягивает лучшие творческие умы планеты.',
  ...
  },
  {
    ...
    era: 10,
    definition:
      'Сиэтлская башня Спейс-Нидл была построена в 1962 году для Всемирной выставки. Воплотив в себе новейший дизайн и инженерное искусство, она стала символом северо-западного побережья Америки, привлекающим миллионы туристов со всего мира.',
  ...
  },
  {
    ...
    era: 10,
    definition:
      'Построенный для Всемирной выставки 1958 года, первой после Второй Мировой войны, Атомиум быстро стал культовым сооружением для Брюсселя. Он продолжает олицетворять дух деятельности, технологического продвижения и сотрудничества, которые являются ключом к будущему Европы.',
  ...
  },
  {
    ...
    era: 11,
    definition:
      'Жилищный комплекс Хабитат-67 являет собой блоки, поставленные друг на друга с виду в хаотическом порядке. Он является одним из самых зрелищных и дальновидных достижений канадской архитектуры. Его сложный дизайн, архитектура, учитывающая аспекты человеческого жилья и плотность застройки городов, продолжает вдохновлять архитекторов всего мира.',
  ...
  },
  {
    ...
    era: 12,
    definition:
      'Храм Лотоса в Нью-Дели — святилище открытое для последователей всех религий, находится в самой густонаселенной части мира. Миллионы людей находят в храме веру и понимание.',
  ...
  },
  {
    ...
    era: 12,
    definition:
      'Башня Инноваций в Гонконге символизирует смелый уход от классической архитектуры и представляет собой уникальную смесь инноваций и интуитивной организации. Может быть, это форма будущего?',
  ...
  },
  {
    ...
    era: 13,
    definition:
      'Эта постройка символизирует единство. Затонувшее здание состоит из нескольких эффектных архитектурных элементов и хранится в прочной стеклянной витрине. Впечатляющая конструкция напоминает собор и опирается на саму себя, являясь символом поддержки и сотрудничества.',
  ...
  },
  {
    ...
    era: 13,
    definition:
      'Смесь отеля и гигантского вращающегося колеса, Вояджер V1 обладает роскошными кабинами, которые медленно вращаются и открывает превосходный обзор. Они подойдут для коктейльных вечеринок, свадебных торжеств, небольших конференций или тайных встреч, на которых будет решаться судьба стран.',
  ...
  },
  {
    ...
    era: 14,
    definition:
      'Построенный в научных целях гигантский биосферный проект «Арка» включает в себя ряд различных экосистем, заключенных в лаборатории замкнутого цикла. Ученые со всего мира собираются, чтобы поделиться уникальными открытиями о нашей планете.',
  ...
  },
  {
    ...
    era: 14,
    definition:
      'Для борьбы с природными бедствиями типа пожаров и засух в огромном небоскребе проекта «Дождевой лес» производится сбор и хранение дождевой воды. Этой уникальной конструкцией управляют люди из разных стран мира, взамен получающие широкий спектр научных знаний.',
  ...
  },
  {
    ...
    era: 15,
    definition:
      'Гея, Гайя, Теллура или Мать Природа, она — это персонификация планеты Земля. Эта статуя посвящена Богине, которая может быть одновременно мирной и воинственной.',
  ...
  },
  {
    ...
    era: 15,
    definition:
      'Зернохранилище сохраняет большое разнообразие семян растений и защищает их генетический код от глобальных катастроф и стихийных бедствий. Хранящиеся замороженные образцы семян являются резервными копиями других банков мировых семян.',
  ...
  },
  {
    ...
    era: 16,
    definition:
      'В прошлом это был памятник бесстрашию и неукротимой мощи империи. Не так давно его снова открыли и превратили в популярный музей. Некоторые считают, что это единственное веское доказательство существования Атлантиды, поэтому легенда о ней всё ещё жива',
  ...
  },
  {
    ...
    era: 17,
    definition:
      'Терракотовая армия была создана в честь китайского императора Цинь Шихуанди. Сейчас туристы могут увидеть не только статуи воинов, но и виртуальные дополнения, демонстрирующие армию в движении, а также дополнительную информацию.',
  ...
  },
  {
    ...
    era: 17,
    definition:
      'Замок Химэдзи невероятно красив, однако поговаривали, что захватить его невозможно. Сейчас на него наложены виртуальные изображения, которые показывают, как он менялся в ходе строительства.',
  ...
  },
  {
    ...
    era: 18,
    definition:
      '«Звездочёт» — один из самых мощных наземных телескопов, с помощью которого можно в подробностях рассмотреть Солнечную систему. Он сыграл ключевую роль в колонизации Марса.',
  ...
  },
  {
    ...
    era: 18,
    definition:
      'Целью проекта «Дева» являлся запуск космических зондов. Но при строительстве произошла ошибка, в результате которой изначальная цель оказалась недостижимой. Поэтому проект теперь используется для запуска военных ракет.',
  ...
  },
  {
    ...
    era: 19,
    definition:
      'Космический авианосец обеспечивает связь с городами по всему миру и даже с другими планетами. Чем лучше связь, тем больше ресурсов в нашей столице.',
