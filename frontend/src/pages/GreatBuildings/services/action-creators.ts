...
export const insertGreatBuilding = (greatBuilding: GreatBuildingType) => ({ type: GREAT_BUILDING_INSERT, greatBuilding } as const);

export const updateGreatBuilding = (greatBuilding: GreatBuildingType) => ({ type: GREAT_BUILDING_UPDATE, greatBuilding } as const);
